  ...
  return (
    ...
    <div className="max-w-6xl mx-auto space-y-8">
        ...
        <motion.div
            ...
            <Button variant="ghost" onClick={() => navigate("/courses")} icon="ArrowLeft">Back to Courses
                          </Button>
            {isEnrolled && <div className="flex items-center space-x-4">
                <div className="text-sm text-gray-600">Progress: {progress}%
                                  </div>
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <motion.div
                    ...
                    <Card className="overflow-hidden">
                        {/* Hero Section */}
                        <div
                            className="relative bg-gradient-to-br from-primary-500 via-primary-600 to-secondary-600 p-8 text-white">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-start justify-between mb-6">
                                    <div className="flex-1">
                                        <div className="flex items-center space-x-3 mb-4">
                                            ...
                                            <Badge
                                                variant="outline"
                                                className="bg-white/20 text-white border-white/30 backdrop-blur-sm capitalize">
                                ...
                                {!isEnrolled ? <Button
                                    ...
                                    icon="Play">Start Learning Journey
                                                          </Button> : <div className="flex items-center space-x-4">
                                    <Button
                                        onClick={() => navigate(`/modules/${modules[0]?.Id}`)}
                                        size="lg"
                                        className="bg-white text-primary-600 hover:bg-gray-50 font-semibold px-8 shadow-lg"
                        ...
                        <div className="space-y-4">
                            {modules.map((module, index) => {
                                const isCompleted = sessions.some(
                                    session => session.ModuleId === module.Id && session.CompletionStatus === "completed"
                                );

                                const isAccessible = isEnrolled && (index === 0 || modules.slice(0, index).every(prevModule => sessions.some(
                                    session => session.ModuleId === prevModule.Id && session.CompletionStatus === "completed"
                                )));
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={`p-4 rounded-lg border-2 transition-all duration-200 ${isCompleted ? "border-green-200 bg-green-50" : isAccessible ? "border-blue-200 bg-blue-50 hover:border-blue-300 cursor-pointer" : "border-gray-200 bg-gray-50"}`}
                                        onClick={() => {
                                            if (isAccessible) {
                    ...
                    <motion.div
                        ...
                        <Card className="p-6 ai-card">
                            ...
                            <div className="space-y-3 text-sm text-gray-600">
                                ...
                                <div
                                    className="mt-4 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                                    <p className="text-xs font-medium text-blue-800 mb-1">Personalized for You</p>
                                    <p className="text-xs text-blue-700">Based on your learning pattern, consider starting with {modules.length > 0 ? "15-20 minute sessions" : "foundational concepts"}
