...
<div className="flex items-center space-x-4">
          ...
          >
            <AppIcon name={theme === 'dark' ? "Sun" : "Moon"} size={20} className="text-gray-600 dark:text-gray-300" />
          </button>
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    {notifications.length === 0 ? (
                      <div className="p-4 text-center text-gray-500 dark:text-gray-400">
                        <AppIcon name="Bell" size={24} className="mx-auto mb-2 opacity-50" />
...
{/* Profile */}
            ...
            <AnimatePresence>
              {showProfile && (
                ...
                >
                  <div className="p-2">
                    <a href="/profile" className="flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-gray-900 dark:text-gray-100">
